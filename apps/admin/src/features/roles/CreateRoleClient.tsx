...
import type { CourseOptions, PermissionGroup } from "./types";
import { createRoleAction, type RoleInput } from "./actions";
...
export function CreateRoleClient({ permissionGroups, courseOptions }: Props) {
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      ...
      const res = await createRoleAction(input);
      if (res.success) {
