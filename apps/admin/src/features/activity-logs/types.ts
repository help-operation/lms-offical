...
export const ACTION_LABELS: Record<string, string> = {
  ...
  enrollment_payment_recorded:     "Recorded enrollment payment",
  live_enrollment_deleted:         "Removed live enrollment",
  live_enrollment_payment_recorded:"Recorded live enrollment payment",
  ...
  course_trashed:                  "Trashed course",
  course_restored:                 "Restored course",
  course_purged:                   "Permanently deleted course",
  course_scheduled:                "Scheduled course",
  course_unscheduled:              "Unscheduled course",
  // Live courses
  ...
  live_course_trashed:             "Trashed live course",
  live_course_restored:            "Restored live course",
  live_course_purged:              "Permanently deleted live course",
  live_course_scheduled:           "Scheduled live course",
  live_course_unscheduled:         "Unscheduled live course",
  // Coupons
