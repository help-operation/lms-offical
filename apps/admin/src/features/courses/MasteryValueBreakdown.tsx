  ...
  return (
    <div className="mx-auto max-w-[1160px] px-[10px] py-10">
      ...
      <h2
        ...
        style={{ fontFamily: '"Hind Siliguri", sans-serif', fontSize: 43 }}
      >
      ...
      <div className="text-center">
        ...
        {/* Offer Box */}
        <div className="border border-red-400 bg-white rounded-xl p-6 md:p-8 mx-auto text-center shadow-sm">
          <p
            className="text-gray-900 leading-relaxed"
            style={{ fontFamily: '"Hind Siliguri", sans-serif', fontSize: 32, fontWeight: 600, lineHeight: '49px', color: '#000000' }}
          >
            {offerSubtitle1}
          </p>
          <p
          ...
          <div className="flex justify-center items-center gap-3 md:gap-4">
            <div style={{ padding: 10, backgroundColor: '#FFE4E4', borderStyle: 'dotted', borderWidth: 3, borderColor: '#FF0000', borderRadius: 5, width: 123, height: 80, lineHeight: 1 }} className="flex flex-col items-center justify-center">
