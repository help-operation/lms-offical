...
import { createCourseWithTemplateAction } from "@/features/courses/actions/courses.actions";
...
interface NewCourseFormWithTemplateProps {
  categories: Category[];
  template: "1" | "2";
  templateName: string;
...
// ─── New Course Form With Template ─────────────────────────────────────────────

export function NewCourseFormWithTemplate({
  categories: initialCategories,
  template,
  templateName,
  onSuccess,
}: NewCourseFormWithTemplateProps) {
