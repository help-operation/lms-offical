...
import { Minus, Hand, Video } from "lucide-react";
        ...
        <div className="text-center mb-3">
          ...
          <div className="flex items-center justify-center gap-5" style={{ fontFamily: '"Hind Siliguri", Sans-serif' }}>
            <span className="flex items-center gap-2 text-purple-600">
              ...
              <span className="font-semibold text-[18px]">{toBengaliNumber(totalModules)}</span>
              <span className="font-semibold text-[18px]">{headerModuleLabel}</span>
            </span>
            <span className="flex items-center gap-2 text-purple-600">
              <Video className="h-5 w-5 text-orange-500" />
              <span className="font-semibold text-[18px]">{headerCourseTypeLabel}</span>
            </span>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between px-5 py-4 text-left transition-all duration-300 rounded-sm ${isOpen
