...
export const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/student-filters", label: "Student Filters", icon: UserList, color: "bg-indigo-500" },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/admin/payments", label: "Payments", icon: CreditCard, color: "bg-emerald-500", perm: "view_revenue" },
      { href: "/admin/failed-payment", label: "Failed Payments", icon: XCircle, color: "bg-red-500", perm: "view_revenue" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/settings/payment", label: "Payment Settings", icon: CreditCard, color: "bg-emerald-600", perm: "view_settings_payment" },
      ...
      { href: "/admin/settings/backup", label: "Backup & Restore", icon: Database, color: "bg-emerald-600", perm: "view_settings_configaction" },
