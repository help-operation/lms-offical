...
export function PhoneCallIcon() {
  return (
    <span className="flex h-7 w-7 items-center justify-center rounded-full bg-brand-100 text-brand-600 dark:bg-brand-500/15 dark:text-brand-400">
...
export function PaymentGuideModal({ url, onClose }: { url: string; onClose: () => void }) {
