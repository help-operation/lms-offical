...
export default async function StudentQuizzesPage() {
      ...
      <div className="mx-auto max-w-4xl">
        <div className="rounded-2xl border border-dashed border-slate-200 bg-white p-8 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-2 max-w-md mx-auto text-sm text-slate-500 dark:text-slate-400">
            Enroll in a course to access quizzes and exams.
          </p>
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      {/* Info banner */}
      <div className="rounded-2xl border border-purple-200 bg-purple-50 p-4 dark:border-purple-800/30 dark:bg-purple-500/5">
        <p className="text-sm text-purple-700 dark:text-purple-300">
          Quizzes and exams are available within course lessons. Complete lessons to unlock quizzes.
        </p>
      </div>

      {/* Courses with quiz access */}
      <div className="rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="border-b border-slate-100 px-5 py-4 dark:border-slate-800">
          <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Your Courses</h3>
          <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">Access quizzes from your enrolled courses</p>
        </div>
            ...
            return (
              ...
              >
                <span className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${
                  e.courseType === "live" ? "bg-green-50 text-green-600 dark:bg-green-500/10 dark:text-green-400" : "bg-purple-50 text-purple-600 dark:bg-purple-500/10 dark:text-purple-400"
                }`}>
