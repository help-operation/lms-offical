...
export const SYSTEM_ROLES = {
  ...
  editor: {
    slug: 'editor',
    name: 'Editor',
    description: 'Can manage content, blog, banners, and website sections.',
  },
  marketingOfficer: {
    slug: 'marketing-officer',
    name: 'Marketing Officer',
    description: 'Can manage leads, interests, SMS/email campaigns, and announcements.',
  },
  accountant: {
    slug: 'accountant',
    name: 'Accountant',
    description: 'Can view invoices, payments, revenue, and financial reports.',
  },
};
...
export const EDITOR_DEFAULT_PERMISSIONS: string[] = [
  ...
  'view_section_contact',
  'update_section_contact',
  'view_section_about',
  'update_section_about',
  'view_section_faq',
  'update_section_faq',
  'view_section_mentors',
  'update_section_mentors',
  'view_page_privacy_policy',
  'update_page_privacy_policy',
  'view_page_return_policy',
  'update_page_return_policy',
  'view_page_terms_conditions',
  'update_page_terms_conditions',
  'view_menus',
  'create_menus',
  'update_menus',
  'delete_menus',
  ...
  'delete_code_snippets',
];

export const MARKETING_OFFICER_DEFAULT_PERMISSIONS: string[] = [
  'view_dashboard',
  'view_leads',
  'update_leads',
  'delete_leads',
...
export const ACCOUNTANT_DEFAULT_PERMISSIONS: string[] = [
  'view_dashboard',
  'view_revenue',
  'view_invoices',
